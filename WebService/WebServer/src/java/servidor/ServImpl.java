...
public class ServImpl extends UnicastRemoteObject{
     ...
     */
    public List<Hotel> consultarHotel(List<Hotel> listaHotels, String destino, int nQuartos, int nPessoas){
     ...
     * @throws RemoteException
     */
    public List<Voo> consultarPassagem(List<Voo> listaVoos, boolean idaVolta, String origem, String destino, LocalDate data, int nPessoas){
        List <Voo> consulta;
     ...
     * @throws RemoteException
     */
    public synchronized boolean comprarReserva(List<Hotel> listaHotels, Reserva reserva){
     ...
     * @throws RemoteException
     */
    public synchronized boolean comprarPassagem(List<Voo> listaVoos, PassagemAerea passagem){
        Voo compra1 = listaVoos.stream()
                .filter(voo -> passagem.dataIda.isEqual(voo.data) &&
                        ...
                        passagem.companhiaIda.equals(voo.companhia) &&
        ...
        if(passagem.idaVolta){
            Voo compra2 = listaVoos.stream()
                .filter(voo -> passagem.dataVolta.isEqual(voo.data) &&
                        ...
                        passagem.companhiaVolta.equals(voo.companhia) &&
                        passagem.nPessoas<=voo.assentosVagos)
                .findAny()
                .orElse(null);
    ...
    public synchronized boolean comprarPacote(List<Voo> listaVoos, List<Hotel> listaHotels, Pacote pacote, int nPessoas, int nQuartos){
     ...
     */
    public void registrarVoo(List<Voo> listaVoos, LocalDate da, String o, String de, String c, int p, int av){
     ...
     */
    public void registrarHotel(List<Hotel> listaHotels, String n, String l, int p, int q){
        Hotel novoHotel = new Hotel(n, l, p, q);
        listaHotels.add(novoHotel);
        notificacaoCliente(EnumTipoInteresse.RESERVA, novoHotel.local, p);
    }
    
    public void registrarHotel(List<Hotel> listaHotels, Hotel novoHotel){
        listaHotels.add(novoHotel);
    }
     ...
     */
    public void registrarPacote(List<Voo> listaVoos, List<Hotel> listaHotels){
     ...
     */
    public List<Hotel> listarHoteis(List<Hotel> listaHotels){
     ...
     */
    public void listarVoos(List<Voo> listaVoos){
